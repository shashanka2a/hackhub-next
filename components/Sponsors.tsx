...
const sponsors = [
  {
    ...
    name: 'VISA',
    logo: 'V',
    track: 'Play, Pay, Repeat: Reinventing Childhood Joy with Modern Payments',
    judgesAssigned: 2,
    prizesOffered: 1,
    prizeValue: '$5,000',
    description: 'Reinventing childhood joy with modern payments technology.',
    color: 'from-blue-500 to-cyan-500',
    tier: 'Platinum',
  },
  {
    id: 2,
    name: 'Okanagan Specialty Fruits',
    logo: 'O',
    track: 'Hack the Farm of the Future',
    judgesAssigned: 2,
    prizesOffered: 1,
    prizeValue: '$3,000',
    description: 'Innovating agriculture through technology and sustainable farming.',
  ...
  },
  {
    ...
    name: 'Statsig',
    logo: 'S',
    track: 'AI That Learns What Works',
    judgesAssigned: 2,
    prizesOffered: 1,
    prizeValue: '$2,500',
    description: 'Building AI that learns what works through data-driven insights.',
  ...
  },
  {
    ...
    prizesOffered: 1,
    prizeValue: '$3,000',
    description: 'Best use of ElevenLabs AI voice technology.',
    color: 'from-red-500 to-pink-500',
    tier: 'Gold',
  },
  {
    id: 5,
    name: 'MLH - GoDaddy Registry',
    logo: 'G',
    track: 'Best Domain Name from GoDaddy Registry',
    judgesAssigned: 1,
    prizesOffered: 1,
    prizeValue: '$1,000',
  ...
  },
  {
    ...
    name: 'MLH - Cloudflare',
    logo: 'C',
    track: 'Best AI Application Built with Cloudflare',
    judgesAssigned: 1,
    prizesOffered: 1,
    prizeValue: '$1,000',
    description: 'Best AI application built with Cloudflare infrastructure.',
  ...
  },
  {
    ...
    prizesOffered: 1,
    prizeValue: '$1,000',
    description: 'Best use of Google\'s Gemini API for AI applications.',
    color: 'from-blue-500 to-purple-500',
    tier: 'Silver',
  },
  {
    id: 8,
    name: 'MLH - Reach Capital',
    logo: 'R',
    track: 'Best Use of AI powered by Reach Capital',
    judgesAssigned: 1,
    prizesOffered: 1,
    prizeValue: '$1,000',
    description: 'Best use of AI powered by Reach Capital.',
    color: 'from-purple-500 to-pink-500',
    tier: 'Silver',
  },
  {
    id: 9,
    name: 'Best Freshman Project',
    logo: 'F',
    track: 'Best Freshman Beginner\'s Project',
    judgesAssigned: 1,
    prizesOffered: 1,
    prizeValue: '$500',
    description: 'Best project by a freshman beginner.',
  ...
  },
  {
    ...
    prizesOffered: 1,
    prizeValue: '$500',
    description: 'DubHacks NEXT track for innovative projects.',
    color: 'from-blue-600 to-purple-600',
    tier: 'Bronze',
  },
  {
    id: 11,
    name: 'VISA - Best Freshman',
    logo: 'V',
    track: 'Best Freshman Beginner\'s Project',
    judgesAssigned: 1,
    prizesOffered: 1,
    prizeValue: '$500',
    description: 'VISA sponsored best freshman beginner project.',
    color: 'from-blue-500 to-cyan-500',
    tier: 'Bronze',
  },
  {
